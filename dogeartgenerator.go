...
func main() {
	...
	image2,err := os.Open("e:\\dogeart\\dogecoinlogo.png")
	if err != nil {
		log.Fatalf("failed to open: %s", err)
	}
	...
	third,err := os.Create("e:\\dogeart\\result.jpg")
	if err != nil {
